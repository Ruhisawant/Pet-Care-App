...
class _RemindersPageState extends State<RemindersPage> {
  ...
  void createUpdatePlan({Plan? plan}) {
    ...
    final dateController = TextEditingController(
      text: plan != null ? "${plan.date.toLocal()}".split(' ')[0] : '',
    );
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        setState(() {
                          ...
                          plans.sort(
                            (a, b) => Plan.getPriorityValue(
                              b.priority,
                            ).compareTo(Plan.getPriorityValue(a.priority)),
                          );
                        });
              ...
              child:
                  plans.isEmpty
                      ...
                      : ListView.builder(
                        ...
                        itemBuilder:
                            (context, index) => PlanTile(
                              plan: plans[index],
                              onToggleCompletion:
                                  () => toggleCompletion(plans[index]),
                              onDelete: () => deletePlan(plans[index]),
                              onEdit:
                                  () => createUpdatePlan(plan: plans[index]),
                            ),
                      ),
            ),
          ],
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: Plan.getPriorityColor(plan.priority),
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ],
